...
// EXAMPLES
/************************/
// node ./bump -minor             (auto updates minor)
// node ./bump --patch 3          (would set 0.1.3)
// node ./bump -patch --major 2   (would auto patch to next and set major to 2)
...
// Map for converting string to index.
var verMap = {
    major: 0,
    minor: 1,
    patch: 2
...
var hasMajor = parseVer(argv.indexOf('-major'));
var hasMinor = parseVer(argv.indexOf('-minor'));
var hasPatch = parseVer(argv.indexOf('-patch'));
var setMajor = parseVer(argv.indexOf('--major'), true);
var setMinor = parseVer(argv.indexOf('--minor'), true);
var setPatch = parseVer(argv.indexOf('--patch'), true);
